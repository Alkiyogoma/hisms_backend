...
urlpatterns = [
    # ── Unified welfare routes (ECD + Primary combined) ──
    path("", views.WelfareListView.as_view(department="all"), name="list"),
    path("submit/", views.WelfareSubmitView.as_view(department="all"), name="submit"),
    path("dashboard/", views.WelfareHODDashboardView.as_view(department="all"), name="hod_dashboard"),
    ...
    # ── Legacy ECD routes (redirect to unified) ──
    path("ecd/", views.WelfareListView.as_view(department="ecd"), name="list_ecd"),
    ...
    # ── Legacy Primary routes (redirect to unified) ──
