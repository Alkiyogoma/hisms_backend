...
DJANGO_DEBUG=0
DJANGO_ALLOWED_HOSTS=connect.hodari.ac.tz,demo.hodari.ac.tz,187.7.21.133,localhost,127.0.0.1
DJANGO_USE_SQLITE=0
...
CORS_ALLOWED_ORIGINS=https://connect.hodari.ac.tz,https://demo.hodari.ac.tz
